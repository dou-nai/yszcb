<template>
	<view class="page bg-white">
		<cu-custom bgColor="bg-gradual-green3" :isBack="true"><block slot="content">找回密码</block></cu-custom>
		<form @submit="formSubmit">
			<view class="cu-form-group margin-top">
				<text class='cuIcon-sign-accn margin-right-xs'></text>
				<input v-model='account' name="account" type="number" placeholder="请输入手机号" placeholder-style="color:#B2B2B2"></input>
