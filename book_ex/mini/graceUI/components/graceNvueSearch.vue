<template>
	<view class="gui-search" :style="{height:height, backgroundColor:background,borderRadius:borderRadius}" @tap.stop="tapme">
		<text class="gui-search-icon grace-icons" 
		:style="{color:iconColor, fontSize:iconFontSize, lineHeight:height, width:iconWidth}">&#xe604;</text>
		<input type="text" class="gui-search-input" :disabled="disabled" value="" :placeholder="placeholder" v-model="inputVal" 
