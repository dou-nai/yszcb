...
.grace-select-menu{position:fixed; width:750rpx; left:0; top:0; flex:1; bottom:0; box-sizing:border-box; z-index:1; overflow:hidden;}
.grace-select-menus{height:260rpx; background:#FFFFFF; padding:0; height:100%; flex:1;}
