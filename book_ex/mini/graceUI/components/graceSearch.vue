<template>
	<view class="gui-search" :style="{height:height, backgroundColor:background,borderRadius:borderRadius}" @tap="togoodsList">
		...
		<input type="text" class="gui-search-input" value="" :disabled="disabled" :placeholder="placeholder" v-model="inputVal" 
...
export default{
	...
	methods:{
		togoodsList(){
			url.navTo("/pages/goodsList/goodsList")
		},
		clearKwd : function () {
			this.inputVal = '';
			this.$emit('clear', '');
