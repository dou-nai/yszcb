...
Route::namespace('Admin')->prefix('Admin')->group(function(){
    ...
    Route::match(['get','post','options'],'/goods/excel_upload','GoodsClassController@excel_upload');
    ...
    Route::match(['get','post'],'/goods_brand/statistics','GoodsBrandController@statistics');
    ...
    Route::match(['get','post',],'/goods/add_excel','GoodsController@add_excel');
	Route::match(['get','post'],'/goods/edit/{id}','GoodsController@edit');
	Route::post('/goods/del','GoodsController@del');
    Route::post('/goods/goods_status','GoodsController@goods_status'); //指定ID 修改上下架

    Route::match(['get','post','options'],'/goods/uploadings','GoodsController@excel_upload');
    ...
    Route::post('/seckill/seckill_enable','SeckillController@seckill_enable');
    Route::post('/seckill/seckill_is_index','SeckillController@seckill_is_index');
    ...
    Route::match(['get','post'],'/store/edit/{id}','StoreController@edit');
    ...
    Route::match(['get','post','options'],'/integral/video_upload','IntegralController@video_upload');//视频上传
    ...
    //分销中心
    Route::get('/CommissionUsers/index','CommissionUsersController@index');
    Route::get('/CommissionOrder/index','CommissionOrderController@index');
    ...
    Route::post('/attr_spec/hot_status','AttrSpecController@hot_status'); //指定ID 修改热门
});
...
Route::namespace('Seller')->prefix('Seller')->group(function(){
	...
	// 商品
    Route::match(['get','post','options'],'/goods/goods_upload','GoodsController@goods_upload');
    Route::match(['get','post','options'],'/goods/excel_upload','GoodsController@excel_upload'); // 商品图片 上传
    Route::match(['get','post'],'/goods/index','GoodsController@index');
    ...
    Route::match(['get','post'],'/goods/card/off','GoodsController@write_off');      //虚拟商品核销
    Route::match(['get','post'],'/goods/card/index','GoodsController@Card_list'); //虚拟商品 卡号列表
    Route::match(['get','post'],'/goods/card/add','GoodsController@card_add');      //虚拟商品核销
    ...
    Route::match(['get','post','options'],'/store/sp_zhengshu_upload','StoreController@sp_zhengshu_upload');
...
Route::namespace('Home')->group(function(){
    ...
    Route::get('/user/aa','LoginController@aa');
    Route::get('/user/test_login','LoginController@test_login');

    Route::post('/user/forget_password','LoginController@forget_password');//忘记密码
    ...
    Route::post('/user/wx_login','LoginController@wx_login'); // 登录
    Route::post('/user/wx_register','LoginController@wx_register'); // 注册
    ...
    // 秒杀专题页面列表
    Route::post('/seckill/get_seckill_detail','SeckillController@get_seckill_detail');
    ...
    Route::get('/goods/search_goods','GoodsController@search_goods');  // 搜索商铺 或者条件列取
    ...
    Route::post('/order/get_comment_list','StoreCommentController@get_comment_list');  // 获取订单信息评论
    ...
    Route::post('/order/pay_nh','PayNhController@pay');//农行支付
    Route::post('/order/pay_test','PayNhController@paytest');//农行支付
    ...
    Route::get('/integral/goods/search_integral_goods','IntegralController@search_integral_goods'); // 搜索积分产品列表
    ...
    Route::match(['get','post'],'/payment/pay_ok','PayMentController@pay_ok'); // 微信支付
    ...
    // 获取幻灯片
    Route::get('/api/get_banner','ApiController@get_banner');

     //获取公告
     Route::any('/api/get_notice','ApiController@get_notice');
     Route::any('/api/get_notice_detail','ApiController@get_notice_detail');

    // 获取热门搜索
    Route::get('/api/get_attr_spec','ApiController@get_attr_spec');

     Route::any('/Commission/getInfoOne','CommissionController@getInfoOne');
     Route::any('/Commission/getPoster','CommissionController@getPoster');


     // ---------------------  购物中心接口 ------------------------- //
    Route::post('/shopping/add_cart','ShoppingController@add_cart');  // 加入购物商品
    Route::post('/shopping/change_cart','ShoppingController@change_cart');  // 购物商品数据修改
    Route::post('/shopping/del_cart','ShoppingController@del_cart');  // 购物商品数据删除
    Route::get('/shopping/get_cart_list','ShoppingController@get_cart_list');  // 购物商品数据获取
    Route::get('/shopping/get_cart_count','ShoppingController@get_cart_count');  // 购物商品数据数量
    Route::any('/shopping/get_wxqr','ShoppingController@get_wxqr');  // 生成小程序码

    //虚拟商品
    Route::any('/card/info','cardController@info');
    Route::any('/card/write_off','cardController@write_off');
    Route::any('/card/list','cardController@list');


    Route::get('/check_phone','ApiController@check_phone');
    Route::any('/is_seller','LoginController@is_seller');
