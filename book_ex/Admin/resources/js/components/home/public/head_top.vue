    ...
    <div class="head">
        <div class="head_in">
            <div class="top_shop_left">
                <!-- <ul>
                    <li><router-link to="/">博亚官网</router-link></li>
                    <li>|</li>
            ...
            <div class="top_shop_right">
                <ul>
                    <li v-show="!isLogin"><router-link to="/ceshi/login">登录</router-link></li>
                    ...
                    <li>|</li>
                    <li><router-link to="/store/join" style="color:#ca151e">供应商入驻</router-link></li>
                    <li>|</li>
