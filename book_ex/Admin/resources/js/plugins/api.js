...
//export const baseUrl="http://192.168.1.102:8082/api/";
//export const baseUrl="https://ysz.cmx666.cn/api/";
//export const baseUrl="http://192.168.1.107/api/";
export const baseUrl="http://book.test/api/";
export const api = {
    ...
    'getStatistics' : baseUrl + "Admin/goods_brand/statistics",
    ...
    'addAdminGoods' : baseUrl + "Admin/goods/add",
    'addAdminGoodsExcel' : baseUrl + "Admin/goods/add_excel",
    'editAdminGoods' : baseUrl + "Admin/goods/edit/",
    'excelUpload': baseUrl + "Admin/goods/uploadings",
    //'excelUpload' : baseUrl +"Seller/goods/excel_upload",
    ...
    //商铺轮播图
	'getStoreAdvList' : baseUrl + "Seller/adv/index",
	'addStoreAdv' : baseUrl + "Seller/adv/add",
	'editStoreAdv' : baseUrl + "Seller/adv/edit/",
	'delStoreAdv' : baseUrl + "Seller/adv/del",
    'advStoreUpload' : baseUrl + "Seller/adv/adv_upload", // 品牌图片上传

    // 秒杀
    'getSeckillList' : baseUrl + "Admin/seckill/index",
    'seckill_enable' : baseUrl + "Admin/seckill/seckill_enable",
    'seckill_is_index' : baseUrl + "Admin/seckill/seckill_is_index",
    'addSeckill' : baseUrl + "Admin/seckill/add",
    'editSeckill' : baseUrl + "Admin/seckill/edit/",
    'delSeckill' : baseUrl + "Admin/seckill/del",
    'getAddSeckillGoods' : baseUrl + "Admin/seckill/get_add_seckill_goods", // 获取秒杀图书
    'changeSeckillStatus' : baseUrl + "Admin/seckill/change_status", // 修改审核状态
    'delSeckillGoods' : baseUrl + "Admin/seckill/del_seckill_goods", // 删除
    'adminAddSeckillGoods' : baseUrl + "Admin/seckill/add_seckill_goods", // 添加秒杀图书
    // 站点协议
    ...
    'addStore' : baseUrl + "Admin/store/add",
    'editStore' : baseUrl + "Admin/store/edit/",
    // 积分商城
    ...
    'videoUpload' : baseUrl + "Admin/integral/video_upload",//视频上传
    ...
    // 分销API
    'commissionGetUsersList' : baseUrl + "Admin/CommissionUsers/index",
    'adminCommissionGetOrderList' : baseUrl + "Admin/CommissionOrder/index",
    ...
    'hotStatusAttrSpec' : baseUrl + "Admin/attr_spec/hot_status",
    // 供应商自定义分类
    ...
    'card' : baseUrl + "Seller/goods/card/index",
    'card_off' : baseUrl + "Seller/goods/card/off",
    'card_add' : baseUrl + "Seller/goods/card/add",
    ...
    'storeAfterSaleContent' : baseUrl + "Seller/store/after_sale_content",  // 设置图书详情页面售后服务
    'sellerGetAreaList' : baseUrl + "Seller/area/get_area_list",
    'storeLogoUpload' : baseUrl + "Seller/store/logo_upload",
    'spZhengshuUpload' : baseUrl + "Seller/store/sp_zhengshu_upload", // 商铺证书上传
    ...
    'sellerAddSeckillGoods' : baseUrl + "Seller/seckill/add_seckill_goods", // 添加秒杀图书
    'sellerGetAddSeckillGoods' : baseUrl + "Seller/seckill/get_add_seckill_goods", // 获取秒杀图书
    ...
    "homeGetSeckillDetail" : baseUrl + "seckill/get_seckill_detail", // 获取秒杀
    ...
    'homeGetCommentListByGoods' : baseUrl + "goods/get_comment_list_by_goods",  // 获取评论列表根据图书ID
    ...
    // 供应商首页
    "homeGetStoreInfo" : baseUrl + "store/get_store_info", // 获取供应商信息
    "homeGetStoreIndexInfo" : baseUrl + "store/get_store_index_info", // 获取供应商首页信息
    "homeGetStoreGoodsClass" : baseUrl + "store/get_store_class", // 获取供应商分类信息
    "homeGetStoreClassGoods" : baseUrl + "store/get_store_class_goods", // 获取供应商分类信息和图书列表

    // 积分商城
    "homeGetIntegralIndexInfo" : baseUrl + "integral/get_index_info", //
    "homeGetIntegralGoodsInfo" : baseUrl + "integral/goods/info/", // 获取积分图书详情
    "homeSearchIntegralGoods" : baseUrl + "integral/goods/search_integral_goods", // 获取积分条件列表
    "homeGetIntegralGoodsClass" : baseUrl + "integral/goods/get_integral_goods_class", // 获取积分图书分类

    // 积分商城创建订单
    "homeIntegralCreateOrder" : baseUrl + "integral/order/create_order", // 获取积分图书分类
