        ...
        <div class="cart_body">
            ...
            <div class="store_goods_all  width_center_1200" v-if="cart_list.length>0">
                <div class="store_goods_all_store_info" v-for="(v,k) in cart_list" :key="k">
                    <el-checkbox :indeterminate="store_list_check[k].chose" v-model="store_list_check[k].check" @change="handleStoreChange(k)">{{v[0].store_name}}<span>进入出版社</span></el-checkbox>
                    <ul>
            ...
            <div class="store_goods_list width_center_1200">
                <div class="store_goods_list_title">
                    <el-row>
                        ...
                        <el-col :span="4"><div class="topay2">已选择<font color="#ca151e">{{total_num}}</font>件图书</div></el-col>
