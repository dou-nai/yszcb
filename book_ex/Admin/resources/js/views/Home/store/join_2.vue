        ...
        <div class="join_over width_center_1200">
            <div class="join_bzt">
                <el-steps :active="0" simple>
                    ...
                    <el-step title="供应商等待审核" icon="el-icon-unlock"></el-step>
                    <el-step title="完善出版社信息" icon="el-icon-tickets"></el-step>
                    <el-step title="出版社上线" icon="el-icon-goods"></el-step>
                </el-steps>
            </div>
        </div>
        <div class="join_over width_center_1200">
            ...
            <div class="company_info">
                <el-form  label-width="140px" ref="info" :model="info">
                    ...
                    <el-form-item label="出版社介绍" prop="store_description"><el-input type="textarea" placeholder="请输入内容" v-model="info.store_description"></el-input></el-form-item>
                    ...
                    <el-form-item label="申请图书分类" prop="class_info" :rules="[{required:true,message:'申请图书分类不能为空',trigger: 'blur' }]"><el-cascader v-model="info.class_info" :props="props2" :options="class_list"></el-cascader></el-form-item>
                </el-form>
            </div>
