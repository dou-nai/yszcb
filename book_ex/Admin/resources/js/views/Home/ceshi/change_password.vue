        ...
        <el-main>
            <div style="position: relative;">
                <div class="change_password_main_top">
                    <p class="personage">修改密码</p>
                </div>
                <div class="change_password_main_bottom">
                    <el-card class="box-card">
                        <div class="box-card-top">
                            <p class="box-card-title">云书展·修改密码</p>
                        </div>
                        <div class="box-card-main">
                            <el-form label-width="0" class="demo-ruleForm">
                                <el-form-item>
                                    <el-input v-model="info.phone" placeholder="请输入手机号" readonly=""></el-input>
                                </el-form-item>
...
export default {
    ...
    created() {
        ...
        if(!this.$isEmpty(user_info)){
            ...
            this.info.phone=this.user_info.phone;
        }else{
            this.$router.push('/ceshi/login');
        }
