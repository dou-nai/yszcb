        ...
        <el-dialog title="售后处理" :visible.sync="afterSale">
            ...
            <div class="after_sale">
                <el-form ref="after_sale" label-width="120px">
                    ...
                    <el-form-item label="供应商发货单号" v-if="afterSaleInfo.refund_step == 3">
                        {{afterSaleInfo.refund_no+'（供应商已经发货，收到图书后请确定收货）'}}
                    </el-form-item>
                    <el-form-item label="供应商发货单号" v-if="afterSaleInfo.refund_step == 4">
                        售后已经处理结束！
                    </el-form-item>
                </el-form>
