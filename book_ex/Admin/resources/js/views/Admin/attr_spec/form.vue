        ...
        <div class="admin_main_block">
            ...
            <div class="admin_form_main">
                <el-form  label-width="100px" ref="info" :model="info">
                    <el-form-item label="关键字" prop="spec_name" :rules="[{required:true,message:'关键字不能为空',trigger: 'blur' }]"><el-input placeholder="请输入内容" v-model="info.spec_name"></el-input></el-form-item>
