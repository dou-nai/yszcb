        ...
        <div class="admin_main_block">
            <div class="admin_main_block_top">
                <div class="admin_main_block_left">
                    <div><router-link to="/Admin/attr_spec/form"><el-button type="primary" icon="el-icon-plus">添加</el-button></router-link></div>
            ...
            <div class="admin_table_main">
                <el-table :data="list" @selection-change="handleSelectionChange" >
                    ...
                    <el-table-column label="关键字" prop="spec_name"></el-table-column>
                    <el-table-column label="来源" prop="attr_name"></el-table-column>
                     <el-table-column label="是否热门">
                        <template slot-scope="scope">
                            <div :class="scope.row.is_hot==1?'green_round':'gray_round'" @click="goods_status(scope.row.id)"></div>
                        </template>
                    </el-table-column>
                    <el-table-column label="操作" fixed="right" width="120px">
                        <template slot-scope="scope">
                            <el-button icon="el-icon-edit" @click="$router.push({name:'admin_attr_spec_form',params:{id:scope.row.id}})">编辑</el-button>
...
export default {
    ...
    methods: {
        ...
        goods_status:function(id){
            this.$post(this.$api.hotStatusAttrSpec,{id:id}).then(res=>{
                if(res.code==200){
