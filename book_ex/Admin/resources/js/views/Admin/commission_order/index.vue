        ...
        <div class="admin_main_block">
            ...
            <div class="admin_table_main">
                <el-table :data="list" @selection-change="handleSelectionChange" >
                    ...
                    <el-table-column label="图书名称" width="270px">
                    ...
                    <el-table-column label="加入时间">
                     ...
                     <el-table-column prop="agentid" label="一级分销商" width="300px">
                        <template slot-scope="scope">

                            <dl class="table_dl" v-if="scope.row.commission_order.length>0 && scope.row.commission_order[0] && scope.row.commission_order[0].fl_user">
                                <dt><img :src="scope.row.commission_order[0].fl_user.avatar||require('@/assets/default_avatar.jpg')" width="50px" height="50px"></dt>
                                <dd class="table_dl_dd_all_30">用户昵称： {{ scope.row.commission_order[0].fl_user.nickname }}</dd>
                                <dd class="table_dl_dd_all_16_gray">返利余额： {{ scope.row.commission_order[0].fxmoney }}</dd>
                                <dd class="table_dl_dd_all_16_gray">返利积分： {{ scope.row.commission_order[0].fxintegral }}</dd>
                            </dl>
                     ...
                     <el-table-column prop="agentid" label="二级分销商" width="300px">
                        <template slot-scope="scope">

                           <dl class="table_dl" v-if="scope.row.commission_order.length>0 && scope.row.commission_order[1] && scope.row.commission_order[1].fl_user">
                                <dt><img :src="scope.row.commission_order[1].fl_user.avatar||require('@/assets/default_avatar.jpg')" width="50px" height="50px"></dt>
                                <dd class="table_dl_dd_all_30">用户昵称： {{ scope.row.commission_order[1].fl_user.nickname }}</dd>
                                <dd class="table_dl_dd_all_16_gray">返利余额： {{ scope.row.commission_order[1].fxmoney }}</dd>
                                <dd class="table_dl_dd_all_16_gray">返利积分： {{ scope.row.commission_order[1].fxintegral }}</dd>
                            </dl>
                     ...
                     <el-table-column prop="agentid" label="三级分销商" width="300px">
                        <template slot-scope="scope">

                           <dl class="table_dl" v-if="scope.row.commission_order.length>0 && scope.row.commission_order[2] && scope.row.commission_order[2].fl_user">
                                <dt><img :src="scope.row.commission_order[2].fl_user.avatar||require('@/assets/default_avatar.jpg')" width="50px" height="50px"></dt>
                                <dd class="table_dl_dd_all_30">用户昵称： {{ scope.row.commission_order[2].fl_user.nickname }}</dd>
                                <dd class="table_dl_dd_all_16_gray">返利余额： {{ scope.row.commission_order[2].fxmoney }}</dd>
                                <dd class="table_dl_dd_all_16_gray">返利积分： {{ scope.row.commission_order[2].fxintegral }}</dd>
                            </dl>
...
export default {
    ...
    methods: {
        ...
        get_order_list:function(){
            ...
            this.$get(this.$api.adminCommissionGetOrderList,where).then(res=>{
