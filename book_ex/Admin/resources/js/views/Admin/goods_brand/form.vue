        ...
        <div class="admin_main_block">
            ...
            <div class="admin_form_main">
                <el-form  label-width="100px" ref="info" :model="info">
                    <el-form-item label="展厅名" prop="name" :rules="[{required:true,message:'展厅名不能为空',trigger: 'blur' }]"><el-input placeholder="请输入内容" v-model="info.name"></el-input></el-form-item>
                    <el-form-item label="位置" prop="address" :rules="[{required:true,message:'位置不能为空',trigger: 'blur' }]"><el-input placeholder="请输入内容" v-model="info.address"></el-input></el-form-item>
                    <el-form-item label="牌号" prop="brand_num" :rules="[{required:true,message:'牌号不能为空',trigger: 'blur' }]"><el-input placeholder="请输入内容" v-model="info.brand_num"></el-input></el-form-item>
