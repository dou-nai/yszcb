            ...
            <div class="admin_table_main">
                <el-table :data="list" @selection-change="handleSelectionChange" >
                    ...
                    <el-table-column label="广告类型">
                        <template slot-scope="scope">
                            <span class="user_list_roles">
                                <el-tag v-if="scope.row.adv_type==0">活动链接</el-tag>
                                <el-tag v-if="scope.row.adv_type==1">产品链接</el-tag>
                                <el-tag v-if="scope.row.adv_type==2">出版社链接</el-tag>
                                <el-tag v-if="scope.row.adv_type==3">内容</el-tag>
                            </span>
                        </template>
                    </el-table-column>
                    <el-table-column prop="adv_link" label="对应ID"> </el-table-column>
                    ...
                    <el-table-column label="广告位">
                        <template slot-scope="scope">
                            <span class="user_list_roles">
                                <el-tag v-if="scope.row.adv_position">{{scope.row.adv_position.ap_name}}</el-tag>
                            </span>
                        </template>
                    </el-table-column>
