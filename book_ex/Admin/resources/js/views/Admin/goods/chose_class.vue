        ...
        <div class="admin_main_block">
            ...
            <div class="admin_form_main">
                ...
                <div class="chose_class_tags">
                    <el-tag type="success">您当前选择的图书类别是： {{class_name.join('&nbsp;&nbsp;&nbsp;')}}</el-tag>
                </div>

                <div class="chose_class_btn">
                    <el-button type="primary" :disabled="chose_class_1==0" @click="next">下一步，填写图书信息</el-button>
                </div>
            </div>
        </div>
    </div>
        ...
        next:function(){
            if(this.chose_class_1==0){
                ...
                if(this.$isEmpty(this.$route.params.goods_id)){
                    this.$router.push("/Admin/goods/add/"+this.chose_class_1);
                }else{
                    this.$router.push("/Admin/goods/edit/"+this.$route.params.goods_id+'?class_id='+this.chose_class_1);
                }
