...
export default {
    ...
    submitForm:function(e){
        ...
        edit_goods:function(){
            ...
            // 请求
            this.$post(this.$api.editAdminGoods+this.$route.params.id,info).then(res=>{
                if(res.code == 200){
        ...
        get_goods_edit_info:function(){
            this.$get(this.$api.editAdminGoods+this.$route.params.id).then(res=>{
                if(res.code == 500){
                    this.$message.error(res.msg);
        ...
        edit_goods_class:function(){
            this.$get(this.$api.addAdminGoods,{class_id:this.$route.query.class_id}).then(res=>{
                if(res.code == 500){
                    this.$message.error(res.msg);
                    this.$router.go(-1);
                }else{
                    this.info.class_list = res.data.class_list;
                    this.info.cid = this.info.class_list[0].id;
                    this.$forceUpdate();
                }
            });
        },
