    ...
    <div class="qingwu">
        <div class="admin_main_block">
            <div class="admin_main_block_top">
                <div class="admin_main_block_left">
                   <div><router-link to="/Admin/store/setting"><el-button type="primary" icon="el-icon-plus">添加</el-button></router-link></div>
                   <div><el-input v-model="where.store_name" placeholder="请输入出版社名"></el-input></div>
            ...
            <div class="admin_table_main">
                <el-table :data="list" @selection-change="handleSelectionChange" >
                    ...
                    <el-table-column prop="id" label="ID" fixed="left" width="70px"></el-table-column>
                    <el-table-column prop="nickname" label="出版社名">
                        <template slot-scope="scope">
                            <dl class="table_dl">
                                ...
                                <dd class="table_dl_dd_all_30"> {{ scope.row.store_name }}</dd>
                            </dl>
                        </template>
                    </el-table-column>
                    <el-table-column label="出版社状态">
                        <template slot-scope="scope">
                            <div :class="scope.row.store_status==1?'green_round':'red_round'" @click="update_store(scope.row)"></div>
                        </template>
                    </el-table-column>
                    <el-table-column prop="store_company_name" label="公司名称"></el-table-column>
                    <el-table-column prop="company_web" label="公司网站"></el-table-column>
                    <el-table-column prop="hall_address" label="展区位置"></el-table-column>
                    <el-table-column label="操作" fixed="right" width="220px">
                        <template slot-scope="scope">
                             <el-button icon="el-icon-edit" @click="$router.push({name:'admin_store_setting',params:{id:scope.row.id}})">编辑</el-button>
        ...
        <el-dialog title="提示" :visible.sync="dialogVisible" width="50%">
            <ul class="store_list_ul">
                <li>
                    <h4>出版社名称:</h4>{{info.store_name||'-'}}
                </li>
                <li>
                    <h4>出版社LOGO:</h4><el-image style="width: 60px; height: 60px" :src="info.store_logo"></el-image>
                </li>
                <li>
                ...
                <li>
                    <h4>出版社状态:</h4><el-radio v-model="info.store_status" :label="0">关闭</el-radio>
...
export default {
    ...
    methods: {
        ...
        get_store_list:function(){
            ...
            this.$post(this.$api.getStoreList,this.where).then(function(res){
        ...
        update_store:function(item){
            this.info=item;
            if(this.info.store_status==0 && this.info.store_close_info == ''){
                return this.$message.error('请填写关闭出版社的原因！');
            }
