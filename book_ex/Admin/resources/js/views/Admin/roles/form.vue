                ...
                <el-form  label-width="100px" ref="info" :model="info">
                    ...
                    <el-form-item class="width_auto">
                        <el-checkbox-group v-model="menus" >
                            <div class="menus_list" v-for="(v,k) in info.menus_list" :key="k">
                                ...
                                <el-tag type="success" style="margin-left:15px;" v-show="v.is_type==1">供应商栏目</el-tag>
                            </div>
                        </el-checkbox-group>
                    ...
                    <el-form-item class="width_auto">
                        <div class="div_apis" v-for="(v,k) in info.hooks_list" :key="k" >
                            ...
                            <el-tag type="success" style="margin-left:15px;" v-if="v.is_type==1">供应商接口</el-tag>
                        </div>


                        <!-- <el-tag type="success" style="margin-left:15px;" v-show="v.is_type==1">供应商接口</el-tag> -->
                    </el-form-item>
                    <el-form-item>
