        ...
        <div class="admin_main_block">
            <div class="admin_main_block_top">
                <div class="admin_main_block_left">
                    <div><router-link to="/Seller/adv/form"><el-button type="primary" icon="el-icon-plus">添加</el-button></router-link></div>
            ...
            <div class="admin_table_main">
                <el-table :data="list" @selection-change="handleSelectionChange" >
                    ...
                    <el-table-column label="操作" fixed="right" width="120px">
                        <template slot-scope="scope">
                            <el-button icon="el-icon-edit" @click="$router.push({name:'store_adv_form',params:{id:scope.row.id}})">编辑</el-button>
...
export default {
    ...
    methods: {
        ...
        get_adv_list:function(){
            ...
            this.$get(this.$api.getStoreAdvList,{page:this.current_page,adv_position_id:this.adv_position_id}).then(res=>{
        ...
        del:function(id){
            ...
            this.$post(this.$api.delStoreAdv,{id:id}).then(res=>{
                if(res.code == 200){
                    this.get_adv_list();
