        ...
        <div class="admin_main_block">
            ...
            <div class="admin_form_main">
                <el-form  label-width="100px" ref="info" :model="info">
                    ...
                    <el-form-item label="广告图" prop="thumb"><el-upload class="avatar-uploader" :action="$api.advStoreUpload" :headers="upload_headers" :show-file-list="false" :on-success="handleAvatarSuccess" >
    ...
    methods: {
        ...
        submitForm:function(e){
            ...
            this.$refs[e].validate(function(res){
                if(res){
                    //  判断是Add 或者 Edit
                    let url = _this.$api.addStoreAdv;
                    if(_this.edit_id>0){
                        url = _this.$api.editStoreAdv+_this.edit_id;
                    }
                    // Http 请求
        ...
        get_adv_info:function(){
            let _this = this;
            this.$get(this.$api.editStoreAdv+this.edit_id).then(function(res){
                _this.info = res.data;
        ...
        get_adv_list:function(){
            let _this = this;
            this.$get(this.$api.addStoreAdv).then(function(res){
                _this.list = res.data;
            })
