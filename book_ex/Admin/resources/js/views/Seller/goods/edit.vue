        ...
        <div class="admin_main_block">
            ...
            <div class="admin_form_main">
                ...
                <el-form  label-width="100px" ref="info" :model="info" >
                    <el-form-item label="图书名" prop="goods_name" :rules="[{required:true,message:'图书名不能为空',trigger: 'blur' }]"><el-input placeholder="请输入内容" v-model="info.goods_name"></el-input></el-form-item>
                    ...
                    <el-form-item label="图书品牌" prop="goods_subname" @change="selectChange()">
                    ...
                    <el-form-item label="图书主图" prop="thumb" class="width_auto">
                    ...
                    <el-form-item label="图书价格" prop="goods_price">
                    ...
                    <el-form-item label="图书库存" prop="goods_num"><el-input :disabled="check_list.length>0" placeholder="0" type="age" v-model.number="info.goods_num"></el-input></el-form-item>
                    ...
                    <el-form-item label="属性价格" class="width_auto_70" v-if="check_list.length>0">
                        <div class="spec_group_title">
                            <el-row>
                                ...
                                <el-col :span="6">图书价格</el-col>
                                <el-col :span="6">市场价格</el-col>
                                <el-col :span="6">图书库存</el-col>
                            </el-row>
                        </div>
                    ...
                    <el-form-item label="限购数量" prop="shop_num">
                        <el-input type="number" placeholder="0" v-model="info.shop_num">
                            <template slot="append">0为不限购</template>
                        </el-input>
                    </el-form-item>

                    <el-form-item label="是否虚拟产品" prop="is_virtual">
                        <el-switch v-model="info.is_virtual" active-color="#13ce66" :active-value="1" :inactive-value="0"></el-switch>
                    </el-form-item>

                    <el-form-item label="卡号开头" prop="pay_code" v-show="info.is_virtual==1" size="medium" style="width:600px">
                        <el-col :span="8">
                        <el-input placeholder="卡号开头字符" v-model="card_sn" ></el-input>
                        </el-col>
                        <el-col :span="4" align="right">
                            开始序号:
                        </el-col>
                        <el-col :span="4">
                        <el-input placeholder="开始序号" v-model="card_start" ></el-input>
                        </el-col>
                        <el-col :span="4" align="right">
                            结束序号:
                        </el-col>
                        <el-col :span="4">
                        <el-input placeholder="结束序号" v-model="card_end" ></el-input>
                        </el-col>
                        <el-col :span="2">
                            <el-button type="button" @click="create_code">生成</el-button>
                        </el-col>
                    </el-form-item>
                    <el-form-item label="卡号列表" v-show="info.is_virtual==1">
...
export default {
        ...
        get_goods_edit_info:function(){
            this.$get(this.$api.editGoods+this.$route.params.id).then(res=>{
                ...
                if(this.$isEmpty(this.$route.query.class_id)){
                    this.info.class_list = res.data.class_list; // 图书栏目分类
                }else{
    ...
    created() {
        if(this.$isEmpty(this.$route.params.id)){
            this.$message.error('没有图书ID，请重新编辑');
            this.$router.go(-1);
        }
