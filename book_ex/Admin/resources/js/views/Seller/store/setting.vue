        ...
        <div class="admin_main_block">
            ...
            <div class="admin_form_main">
                <el-form  label-width="100px" ref="info" :model="info">
                    ...
                    <el-form-item label="出版社描述" prop="store_description"><el-input type="textarea" placeholder="请输入内容" maxlength="200" show-word-limit v-model="info.store_description"></el-input></el-form-item>
                    <el-form-item label="出版社LOGO" prop="store_logo"><el-upload class="avatar-uploader" :action="$api.storeLogoUpload" :headers="upload_headers" :show-file-list="false" :on-success="handleAvatarSuccess" >
                    ...
                    <el-form-item label="是否农行商铺" prop="sp_isnh">
                        <el-switch v-model="info.sp_isnh" active-color="#13ce66" :active-value="1" :inactive-value="0" :active-text="info.sp_isnh==1?'是':'否'"></el-switch>
                    </el-form-item>
                    <div v-if="info.sp_isnh==1">
                        <el-form-item label="商铺编号" prop="sp_number"><el-input placeholder="请输入商铺编号" v-model="info.sp_number"></el-input></el-form-item>
                        <el-form-item label="商铺证书" prop="sp_zhengshu">
                            <el-upload class="uploads-demo" :action="$api.spZhengshuUpload" :headers="upload_headers" :show-file-list="false" :on-success="handleZhengshuSuccess" >
<!--                                <i class="el-icon-plus avatar-uploader-icon"></i>-->
                                <el-button type="button" >上传</el-button>
                            </el-upload>
                            <div v-if="info.sp_zhengshu">
                                {{info.sp_zhengshu}}
                            </div>
                        </el-form-item>
                        <el-form-item label="证书密码" prop="sp_zhengshu_key"><el-input placeholder="请输入证书密码" v-model="info.sp_zhengshu_key" show-password></el-input></el-form-item>
                    </div>
                    <el-form-item>
