                ...
                <el-table :data="list" @selection-change="handleSelectionChange" >
                    ...
                    <el-table-column label="操作" fixed="right" width="280px">
                        <template slot-scope="scope">
                            ...
                            <el-button icon="el-icon-plus" @click="dialogTableVisible=true;sid=scope.row.id;">添加图书</el-button>
                            <el-button icon="el-icon-menu" @click="$router.push('/Seller/seckill/seckill_goods/'+scope.row.id)">查看图书</el-button>
